...
<main>
            ...
            <div class="col-xxl-12">
               <div class="breadcrumb__content p-relative z-index-1">
                  <div class="breadcrumb__list mb-10">
                     ...
                     <span class="tp-bc-acive-menu">Web Development</span>
                  </div>
   ...
   <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
      <div class="sv-page-fea-img-2" data-background="assets/img/services/sv-page-fea-img-2.png"></div>
      <div class="container">
         <div class="row">
   ...
   <div class="tp-sv-page-feature-area black-bg p-relative pt-120 pb-120">
      <div class="sv-page-fea-img-1" data-background="assets/img/services/sv-page-fea-img-3.png"
         style="background-image: url(_assets/img/services/sv-page-fea-img-1.html);"></div>
      <div class="container">
         <div class="row">
            <div class="col-lg-6">
               <div class="tp-sv-fea-ab-content mr-60">
                  ...
                  <!--<div class="tp-ha-about-fea tp-sv-fea-list wow tpfadeUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: tpfadeUp;">-->
                  <!--   <ul>-->
                  <!--      <li><span><i class="fal fa-check"></i></span>Features include Multi Factor-->
                  <!--         Authentication</li>-->
                  <!--      <li><span><i class="fal fa-check"></i></span>We strongly believe in providing open-->
