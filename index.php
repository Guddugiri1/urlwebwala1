    ...
    <div class="tp-it-slider-area">
        <div class="swiper-container ptg-slider-active">
            <div class="swiper-wrapper">
                ...
                <div class="tp-it-slider it-slider-height fix swiper-slide"
                    data-background="assets/img/slider/Social.jpg">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-12">
                                <div class="it-slider__content">
                    ...
                    <div class="unique-scroll-content">
                        ...
                        <div class="unique-client-item">
                            <div class="unique-client-box">
                                <img src="https://www.cluix.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FnewBlackLogo.05398a9e.png&w=256&q=75"
                                    alt="Android">
                            </div>
                        </div>
                        <div class="unique-client-item">
