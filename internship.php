...
$description = 'Accelerate your brand with a top digital marketing and advertising company! SEO, PPC, social media & more to boost traffic, leads, and sales. Start now.';
include('header.php'); ?>
            ...
            <div class="row it-sv-counter">
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow tpfadeUp" data-wow-delay=".3s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/php-code.png" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow tpfadeUp" data-wow-delay=".4s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/design.png" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow data tpfadeUp" data-wow-delay=".5s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/4642761@0.webp" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow data tpfadeUp" data-wow-delay=".5s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/transparent-android.png" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow data tpfadeUp" data-wow-delay=".5s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/react-icon.png" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow data tpfadeUp" data-wow-delay=".5s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/js_logo.png" alt="" style="height: 100px;">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="it-service__item mb-30 text-center wow data tpfadeUp" data-wow-delay=".5s">
                        <div class="it-servicce__item-img mb-35">
                            <img src="assets/img/services/icon/home-project-icon.jpg" alt="" style="height: 100px;">
                        </div>
