         ...
         <div class="container">
            ...
            <div class="row tp-portfolio-isotop-active">
                <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img design">
                  ...
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/newone.png" alt="">
                     </div>
                ...
                <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img business">
                  ...
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/new2.png" alt="">
                     </div>
                ...
                <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img design">
                  ...
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/newtwo.png" alt="">
                     </div>
                ...
                <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img business">
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/new6.png" alt="">
                     </div>
                ...
                <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img business">
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/new9.png" alt="">
                     </div>
               ...
               <div class="col-lg-6 col-xl-4 tp-portfolio-item mb-25 w-img design">
                  ...
                  <div class="pf-item-wrapper p-relative">
                     <div class="pf-single-item">
                        <img src="assets/img/portfolio/newthree.png" alt="">
                     </div>
