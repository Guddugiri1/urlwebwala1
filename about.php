                        ...
                        <div class="row gx-4">
                            ...
                            <div class="col-md-6">
                                <div class="law-about-img-2">
                                    <img src="assets/img/about/Aboutus3.png" alt="">
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-title-wrapper pb-55">
                <div class="tp-section text-center">
                    <span class="tp-section__subtitle vogue-text-color white-bg mb-15 wow tpfadeUp"><i
                        ...
                        Our Expert <i class="after-border"></i></span>
                    <h2 class="tp-section__title vogue-text-color wow tpfadeUp" data-wow-delay=".3s">Brain Behind
                        UrlWebwala It Services
                    </h2>
                    <p class="wow tpfadeUp" data-wow-delay=".3s">Lawyer's content marketing strategy should
                        include adding & updating
                        your most important and high-performing.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="da-team p-relative mb-30 wow tpfadeUp" data-wow-delay=".3s">
                        <div class="da-team-img w-img fix">
                            <img src="assets/img/team/ceo.png" alt="">
                        </div>
                        <div class="da-team-info" data-background="assets/img/team/da-deam-info-bg.png"> <span>Head
                                Of Idea</span>
                            <h3 class="da-team-name"><a href="#">Mixlox D. Jhonson</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="da-team p-relative mb-30 wow tpfadeUp" data-wow-delay=".4s">
                        <div class="da-team-img w-img fix">
                            <img src="assets/img/team/ceo.png" alt="">
                        </div>
                        <div class="da-team-info" data-background="assets/img/team/da-deam-info-bg.png"> <span>Head
                                Of Idea</span>
                            <h3 class="da-team-name"><a href="#">Salim D. Jhonson</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="da-team p-relative mb-30 wow tpfadeUp" data-wow-delay=".5s">
                        <div class="da-team-img w-img fix">
                            <img src="assets/img/team/ceo.png" alt="">
                        </div>
                        <div class="da-team-info" data-background="assets/img/team/da-deam-info-bg.png"> <span>Head
                                Of Idea</span>
                            <h3 class="da-team-name"><a href="#">Samrat Islam Tushar</a></h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 wow tpfadeUp">
                    ...
                    <p class="text-grey wow tpfadeUp" data-wow-delay=".3s">
                        <b>Here is why we stand out:</b>
                    </p>
                    <ul class="text-grey wow tpfadeUp" data-wow-delay=".3s">
                        <li><b>Tailored Solutions &nbsp:</b> Customized strategies to meet your unique project needs.
                        </li>
                        <li><b>Expert Team &nbsp:</b> Skilled professionals delivering impactful results.</li>
                        <li><b>Risk Management &nbsp:</b> Proactive measures to ensure smooth project execution.</li>
                        <li><b>Maximized ROI &nbsp:</b> Solutions designed to optimize your returns.</li>
                        <li><b>Flexible Models &nbsp:</b> Engagement options to match your business preferences.</li>
                        <li><b>Transparent Communication &nbsp:</b> Open updates to save time and costs.</li>
                        <li><b>Long-Term Partnerships &nbsp:</b> Building relationships that grow with your success.
                        </li>
                    </ul>
                    <br>
                    ...
                    <!-- <div class="tp-ab-sv-tabs mb-30">
                        <ul class="nav nav-pills mb-30" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="2000" data-bs-toggle="pill"
                                    data-bs-target="#pills-2000" type="button" role="tab" aria-controls="pills-2000"
                                    aria-selected="true">2000</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="2010" data-bs-toggle="pill" data-bs-target="#pills-2010"
                                    type="button" role="tab" aria-controls="pills-2010"
                                    aria-selected="false">2010</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="2018" data-bs-toggle="pill" data-bs-target="#pills-2018"
                                    type="button" role="tab" aria-controls="pills-2018"
                                    aria-selected="false">2018</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="2022" data-bs-toggle="pill" data-bs-target="#pills-2022"
                                    type="button" role="tab" aria-controls="pills-2022"
                                    aria-selected="false">2022</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-2000" role="tabpanel"
                                aria-labelledby="2000">
                                <div class="tp-ab-sv-tabs-content">
                                    <h3 class="tp-ab-sv-tabs-title">We got featured from <span>Awwrds </span></h3>
                                    <p>Shall over firmament, above there won't image wherein winged moveth twoes
                                        heaven green, the whose had so let evening forth together given form make. Red
                                        moved years face our may male female.</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-2010" role="tabpanel" aria-labelledby="2010">
                                <div class="tp-ab-sv-tabs-content">
                                    <h3 class="tp-ab-sv-tabs-title">We got featured from <span>Themeforest</span></h3>
                                    <p>Shall over firmament, above there won't image wherein winged moveth twoes
                                        heaven green, the whose had so let evening forth together given form make. Red
                                        moved years face our may male female.</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-2018" role="tabpanel" aria-labelledby="2018">
                                <div class="tp-ab-sv-tabs-content">
                                    <h3 class="tp-ab-sv-tabs-title">We got featured from <span>buyers</span></h3>
                                    <p>Shall over firmament, whose there won't image wherein winged moveth twoes
                                        heaven green, the whose had so let evening forth together given form make. Red
                                        moved years face our may male female.</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-2022" role="tabpanel" aria-labelledby="2022">
                                <div class="tp-ab-sv-tabs-content">
                                    <h3 class="tp-ab-sv-tabs-title">We got featured from <span>Your</span></h3>
                                    <p>Shall over firmament, above there won't image wherein winged moveth twoes
                                        heaven green, the whose had so let evening forth together given form make.
                                        Red
                                        moved years face our may male female.</p>
                                </div>
                            </div>
                ...
                <div class="col-xl-6 wow tpfadeUp">
                    <div class="about-sv-img">
                        <img src="assets/img/services/web_developing.gif" alt="">
                    </div>
                </div>
            </div>
        </div>
